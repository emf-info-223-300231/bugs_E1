...
public class B_JpaDaoTest {
  ...
  public void g_testerRechercher() throws MyDBException {
    System.out.println("*** " + SystemLib.getCurrentMethod() + " ...");
    Personne p = persWrk.rechercher("pkPers", 1);
    boolean ok = p != null;
    if (ok) {
      System.out.println("  " + p + " [PK=" + p.getPkPers() + "]");
    }
    assertTrue(ok);
  }
  ...
  public void h_testerLireListe() throws MyDBException {
    ...
    if (ok) {
      ...
      for (Personne p : personnes) {
        ...
        p.setLocalite(null); // pour pouvoir tester ensuite l'effacement d'une liste complète
        p.setDepartement(null); // pour pouvoir tester ensuite l'effacement d'une liste complète
        persWrk.modifier(p);
      }
    }
    assertTrue(ok);
...
//  @Test
//  public void i_testerEffacerListeLocalites() throws MyDBException {
//    System.out.println("*** " + SystemLib.getCurrentMethod() + " ...");
//    long n1 = locWrk.compter();
//    int n2 = locWrk.effacerListe();
//    boolean ok = n1 >= 0 && n2 >= 0;
//    System.out.println("  avant n=" + n1 + ", effacés n=" + n2 + ", ok=" + ok);
//    assertTrue(ok);
//  }
//
//  @Test
//  public void j_testerEffacerListeDepartements() throws MyDBException {
//    System.out.println("*** " + SystemLib.getCurrentMethod() + " ...");
//    long n1 = depWrk.compter();
//    int n2 = depWrk.effacerListe();
//    boolean ok = n1 >= 0 && n2 >= 0;
//    System.out.println("  avant n=" + n1 + ", effacés=" + n2 + ", ok=" + ok);
//    assertTrue(ok);
//  }
//
//  @Test
//  public void k_testerSauverListeLocalites() throws MyDBException, MyFileException {
//    System.out.println("*** " + SystemLib.getCurrentMethod() + " ...");
//
...
//
//    // on lit les localités
//    List<Localite> localites = ficLocWrk.lireFichierTexte(ficLoc, "UTF-8");
//
//    // on sauve les localités dans la BD
//    int n1 = localites.size();
//    int n2 = locWrk.sauverListe(localites);
//    boolean ok = n1 > 0 && n2 == n1;
//    System.out.println("  lus=" + n1 + ", ajoutés=" + n2 + ", ok=" + ok);
//    assertTrue(ok);
//  }
//
//  @Test
//  public void l_testerSauverListeDepartements() throws MyDBException, MyFileException {
//    System.out.println("*** " + SystemLib.getCurrentMethod() + " ...");
//
//    // on prepare l'accès vers le fichier
//    Path cheminDossier = Paths.get(NOM_DOSSIER_DATA).toAbsolutePath();
...
//
//    // on sauve les localités dans la BD
//    int n1 = departements.size();
//    int n2 = depWrk.sauverListe(departements);
//    boolean ok = n1 > 0 && n2 == n1;
//    System.out.println("  lus=" + n1 + ", ajoutés=" + n2 + ", ok=" + ok);
//    assertTrue(ok);
//  }
