...
public class JpaDao<E, PK> implements JpaDaoItf<E, PK> {
    ...
    public List<E> filtrerComme(String prop, String valeur) throws MyDBException {
        List<E> e = null;
        try {
            String jpql = "SELECT e FROM " + cl.getSimpleName() + " e WHERE e." + prop + " LIKE '%"+valeur.toString()+"%'";
            Query query = em.createQuery(jpql);
    ...
    @Override
    @SuppressWarnings("unchecked")
    public List<E> filtrerObjet(String prop, Object valeur) throws MyDBException {
        List<E> e = null;
        try {
